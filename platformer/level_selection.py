...
class LevelSelectionScreen:
    ...
    def __init__(self, screen):
        ...
        self.selected_level = self.available_levels[0] if self.available_levels else "level1"
        ...
        print(f"🎮 Level Selection Screen initialized with {len(self.available_levels)} levels")
