...
class LadderTop(Ladder):
    def __init__(self, x, y):
        ...
        pygame.draw.rect(self.image, (139, 69, 19), (0, 0, GRIDSIZE, GRIDSIZE//3))  # Brown wooden top
    ...
    def can_climb_up(self, player):
        ...
        return (self.climb_rect.colliderect(player.rect) and
    ...
    def can_climb_down(self, player):
        ...
        is_on_top = (player.rect.bottom <= self.rect.top + GRIDSIZE//3 and
                    player.rect.centerx >= self.rect.left and
                    player.rect.centerx <= self.rect.right)
    ...
    def should_block(self, player):
        ...
        keys = pygame.key.get_pressed()
        return (player.rect.bottom <= self.rect.top + GRIDSIZE//3 and
                player.rect.centerx >= self.rect.left and
    ...
    def can_climb_down(self, player):
        ...
        on_top = (player.rect.bottom <= self.rect.top + GRIDSIZE//4 and
                 ...
                 self.climb_rect.collidepoint(player.rect.centerx, player.rect.bottom))
