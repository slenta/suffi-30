...
ENEMY_TYPES = {
    ...
    "baby_erzieherin": {
        ...
        "encounter_message": "Hilfe eine böse Erzieherin!",
        "shoot_cooldown": 60,
        "spawn_on_death": None,
    },
    "buchstabe": {
        "name": "Buchstabe (Boss)",
        "image": "enemies/baby-level/buchstabe.png",
        "speed": 3,
        "patrol_range": 150,
        "size_multiplier": 3,
        "health": 50,
    ...
    "doctor_f_young": {
        "name": "Doctor_f_young",
        "image": "enemies/hospital/ärztin_jung.png",
        "speed": 1,
        "patrol_range": 50,
        "size_multiplier": 4,
        "health": 20,
    ...
    "doctor_f_young_follower": {
        "name": "Doctor_f_young_follower",
        "image": "enemies/hospital/ärztin_jung.png",
        "speed": 2,
        "patrol_range": 0,
        "size_multiplier": 4,
    ...
    "robodog": {
        ...
        "can_throw_explosives": False,
        "can_summon_minions": False,
        "encounter_message": "*wuff* tod allen menschen !",
        "shoot_cooldown": 20,
    },
    "drone": {
        ...
        "size_multiplier": 2,
        "health": 10,
        # Reduce drone projectile damage to make it less punishing
        "damage": 0,
        # Reduce shoot range so drone doesn't attack from too far away
        "shoot_range": 12,
        "chase_range": 100,
        "melee_damage": 0,
        "can_throw_explosives": False,
